...
public class ObjectFactory {
    ...
    private final static QName _AddEmployee_QNAME = new QName("http://core/", "addEmployee");
    private final static QName _AddEmployeeResponse_QNAME = new QName("http://core/", "addEmployeeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: core
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core/", name = "addEmployee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core/", name = "addEmployeeResponse")
